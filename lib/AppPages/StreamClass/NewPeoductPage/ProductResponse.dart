...
class ProductResponse {
    ...
    factory ProductResponse.fromJson(Map<String, dynamic> json) => ProductResponse(
        ...
        productSpecifications: List<ProductSpecification>.from(json["ProductSpecifications"].map((x) => ProductSpecification.fromJson(x))),
        productReviewOverview: ProductReviewOverview.fromJson(json["ProductReviewOverview"]),
        associatedProducts: List<dynamic>.from(json["AssociatedProducts"].map((x) => x)),
        id: json["id"],
    );
